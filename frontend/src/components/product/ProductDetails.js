                    ...
                    <div className="col-12 col-lg-5 mt-5">
                        ...
                        <hr/>
                            ...
                            <p>Status: <span id="stock_status" className={product.stock > 0
                                ? 'greenColor' : 'redColor'} >{product.stock > 0 ? 'In Stock' : 'Out of Stock'}</span></p>
                        ...
                        <h4 className="mt-2">Description:</h4>
                            ...
                            {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal"
                                ...
                                :
                                <div className="alert alert-danger mt-5" type='alert'> Login to
                                post your Review.</div>
                              }
...
export default PreoductDetaiuls
...
exports.createProductReview  = catchAsyncErrors(async (req, res, next) => {
    ...
    product.rating = product.reviews.reduce((ace, item) => item.rating + ace, 0) / product.
        reviews.length
...
exports.getProductsReviews = catchAsyncErrors(async (req, res) => {
...
exports.deleteReviews = catchAsyncErrors(async (req, res, next) => {
    ...
    const ratings = product.reviews.reduce((ace, item) => item.rating + ace, 0) / reviews.length
